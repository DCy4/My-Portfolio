    ...
    return ( 
        ...
        border-stone-200">
            <li className="mb-10 ml-4">
                ...
                text-xs md:text-sm"></p>
                <span className="inline-block px-2 py-1 fonst-semibold text-white bg-stone-900
                rounded-md">
                    {year}
                </span>
                <h3 className="text-lg fonst-semibold text-stone-900">
                    {title}
                </h3>
                <div className="my-1 text-sm font-normal leading-none text-stone-400"> 
                    {duration}
                </div>
                <p className="my-2 text-base fonst-normal text-stone-500">
                    {details}
                </p>
            </li>
